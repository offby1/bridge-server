...
# 2) prevent Google from crawling the site in the first place.  Crawls distract me because the requests appear in my logs, and I'd prefer to see only *real* requests (i.e., from humans or bots playing bridge).
