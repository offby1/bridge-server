...
|--------------------------------+-------------------------------------------------+-----------------------------------+----------------------------------+------------------------------------|
| serialized hand                | HandManager.create                              | all-tables                        | Hand, duh                        |                                    |
| table, final_score             | handrecord.xscript                              | table.pk, all-tables              | n/a [1]                          | when the last card has been played |
| table, player, call            | handrecord.add_call_from_player                 | table.pk, all-tables              | Call                             |                                    |
| table, contract, contract_text | handrecord.add_call_from_player                 | table.pk, all-tables              | n/a [2]                          | when the auction has settled       |
| table, player, card            | handrecord.add_play_from_player                 | table.pk, all-tables              | Play                             |                                    |
| table, seats, action           | table.TableManager.create_with_two_partnerships | all-tables                        | Table                            |                                    |
| serialized board               | BoardManager.create                             | top-sekrit-board-creation-channel | Board, duh                       | not yet used                       |
