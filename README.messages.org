...
|--------------------------------------+-------------------------------------------------+----------------------+--------------------------------------------------|
| json: new-board                      | table_details view                              | table.pk             | GIMME DAT NEW BOARD                              |
| json: board, table, action           | models.HandManager                              | all-tables           | "yo, table X just got board Y"                   |
| json: table, final_score             | handrecord.xscript                              | table.pk, all-tables | when the last card has been played               |
